...
@section('content')
	...
	<div class="container index_container">
		...
		<div class="row">
			...
			<div id="app">
				...
				<div class="panel panel-default panel-shadow panel-profile-index-home">
					<div class="panel-body">
						...
						<div class="img-dp-index-home">
							<img class="profile-img-index-home profile-img-index img-thumbnail img-responsive img-circle" alt="profile" src="{{ Auth::user()->profile_picture }}" data-toggle="modal" data-target="#profile-img"/>
						</div>
			...
			<!-- Column md 6 -->
			<!-- <div class="col-xs-12 col-md-7 col-md-offset-1 right_side" > -->
				<!-- BUTTONS PANEL -->
