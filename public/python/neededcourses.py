...
if __name__ == '__main__':
	student = classes.Student(3, "2016-2017", 2, "BS in Chemical Engineering", classes.createSubjectList("../study plans/bs chemical engineering.csv"), classes.createSubjectList("../csv/3rdYrChemEng.csv"))
